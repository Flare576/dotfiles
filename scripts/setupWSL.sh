...
Grabbing some things, dropping them in C:\\flarescript_temp."

mkdir -p "$target"
# curl -o "$target/Inconsolata.otf" "https://raw.githubusercontent.com/powerline/fonts/master/Inconsolata/Inconsolata%20for%20Powerline.otf"
# curl -o "$target/Inconsolata_bold.ttf" "https://raw.githubusercontent.com/powerline/fonts/master/Inconsolata/Inconsolata%20Bold%20for%20Powerline.ttf"
...
curl -L -o "$target/$latestName" "$latestUrl"
